...
// ICM42688管脚宏定义
// ICM42688,SPC管脚
#define ICM42688_SPC     		P40
// ICM42688,SD1管脚
#define ICM42688_SDI     		P41
// ICM42688,SD0管脚
#define ICM42688_SDO    		P42
// ICM42688,CS管脚
#define ICM42688_CS      		P43

// CS管脚电平操作
#define ICM42688_SPC_LEVEL(level)	(ICM42688_SPC=level)
#define ICM42688_SDI_LEVEL(level)	(ICM42688_SDI=level)
#define ICM42688_CS_LEVEL(level)	(ICM42688_CS=level)

// ICM42688延时
#define ICM42688_DELAY_MS(time)	(delay_ms(time))
